...
``` r
df_stang_long %>% count(thick, angle)
```
...
- Is there “one true value” for the material properties of Aluminum?
  - No, because the E and nu value varies across the measurements
    depending on thickness, indicating there is a range of values
- How many aluminum alloys are in this dataset? How do you know?
  - One, because df_stang_long %\>% distinct(alloy) gives a 1x1 tibble
    which tells me there is only one aluminum alloy for this
    experiment/dataset
- What angles were tested?
  - 0, 45, and 90 degrees
- What thicknesses were tested?
  - 0.022, 0.032, 0.064, 0.081 in
- (Write your own question here)
  - Why are these the thicknessess that were tested, what makes these
    special or is there no specific reason?
...
- (Address your question from q1 here)
  - This graph shows that the thickness changes the stiffness and not
    the direction. I can make this deduction because the 0.081 thickness
    plat is 5% less than the others, which introduces the continuity
    error, meaning it can’t be uniform.
...
- Does this graph support or contradict the claim above?
  - This graph supports because it still shows the clumping of the 0.081
    thickness plate, and how that is an outlier compared to the other
    points.
- Is this evidence *conclusive* one way or another?
  - I would say it is not conclusive. Despite the continuity error that
    rises that there is a correlation, but there is not an explanation
    from this graph that explains why.
